...
declare -gA _TUI_MSG_EN=(
  ...
  [image.type.prefix]="prefix:<value> — strip leading <value> from dirname"
...
declare -gA _TUI_MSG_ZH=(
  ...
  [image.type.prefix]="prefix:<值> — 從目錄名剝除前綴"
...
declare -gA _TUI_MSG_ZH_CN=(
  ...
  [image.type.prefix]="prefix:<值> — 从目录名剥除前缀"
...
declare -gA _TUI_MSG_JA=(
  ...
  [image.type.prefix]="prefix:<値> — ディレクトリ名の前方を除去"
